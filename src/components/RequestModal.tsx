...
const RequestModal: Component<RequestModalProps> = (props: RequestModalProps) => {
  return (
    <Show when={props.show}>
      <div class="fixed top-0 left-0 right-0 bottom-0 bg-[rgba(0,0,0,0.3)]">
        <div class="relative top-14 bg-gray-200 max-w-md m-auto h- block p-8 pb-24 border-t-4 border-pink-600 rounded-sm shadow-xl" use:clickOutside={props.onModalHide}>
